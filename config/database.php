...
return [
    ...
    */
    ...
    'companies_house_ph' => [
        'driver' => 'mysql',
        'host' => env('DB_PH_HOST', '127.0.0.1'),
        'port' => env('DB_PH_PORT', '3306'),
        'database' => env('DB_PH_DATABASE', 'companies_house_ph'),
        'username' => env('DB_PH_USERNAME', 'root'),
    ...
    'companies_house_my' => [
        'driver' => 'mysql',
        'host' => env('DB_MY_HOST', '127.0.0.1'),
        'port' => env('DB_MY_PORT', '3306'),
        'database' => env('DB_MY_DATABASE', 'companies_house_my'),
        'username' => env('DB_MY_USERNAME', 'root'),
